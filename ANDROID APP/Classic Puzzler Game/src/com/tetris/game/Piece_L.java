...
/**
 *
 * Class that represent the L piece of the tetris's game
 *
 *         ____                                 ____ ____                      ____
 *    FREE|b1  |FREE       FREE FREE FREE      |b4  |b3  |FREE       FREE FREE|b4  |
 *        |____|           ____ ____ ____      |____|____|           ____ ____|____|
 *    FREE|b2+ |FREE      |b3  |b2+ |b1  |      FREE|b2+ |FREE      |b1  |b2+ |b3  |
 *        |____|____      |____|____|____|          |____|          |____|____|____|
 *    FREE|b3  |b4  |     |b4  |FREE FREE       FREE|b1  |FREE       FREE FREE FREE
 *        |____|____|     |____|                    |____|
 *    
...
public class Piece_L extends Piece {
	...
	public static final String colorL = "#FFA500";			// Orange
	public static final String marginColorL = "#000000";	// Black
	
	/**
	 * 
	 * Constructs a Piece_L object with the specified arguments. This object represent the L piece of tetris's game.
	 * It uses the default colors: orange of filler and black for margin.
	 * 
	 * @param b1 Block 1
	 * @param b2 Block 2
	 * @param b3 Block 3
	 ...
	 */
    public Piece_L(Block b1, Block b2, Block b3, Block b4, Tetris board) {
    	super(b1, b2, b3, b4,colorL,marginColorL, board);
    }
	 ...
	 * @param board Tetris's game
	 */
    public Piece_L(Block b1, Block b2, Block b3, Block b4, Tetris board, String color, String marginColor) {
    ...
    public boolean rotate() {
    	...
    	if (rotation == EnumPieceRotation.Rot0Degrees) {
    		...
    		if(!board.isBlockBusy(b2.getRow(), b2.getColumn()+1) && !board.isBlockBusy(b2.getRow(), b2.getColumn()-1) && !board.isBlockBusy(b2.getRow()-1, b2.getColumn()+1) && !board.isBlockBusy(b2.getRow()+1, b2.getColumn()-1)){
    			...
    			generateShadow();
    			return true;
    		} else if(!board.isBlockBusy(b2.getRow(), b2.getColumn()+1) && !board.isBlockBusy(b2.getRow(), b2.getColumn()+2) && !board.isBlockBusy(b2.getRow()-1, b2.getColumn()+1)){
    			...
    			b4 = b3;
    			b3 = b2;
    			b1 = board.getBlock(b2.getRow(), b2.getColumn()+2);
